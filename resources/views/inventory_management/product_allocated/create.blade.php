                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-4"> 
                                            <div class="form-group">
                                                ...
                                                <input class="form-control datepicker" id="pmodel" name="date" type="text" aria-describedby="emailHelp" placeholder="Assign Date" required="">
                                        ...
                                        <div class="col-md-4"> 
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Remark/Condition</label>  <textarea class="form-control" name="remark" placeholder="Remark/Condition" required rows="4"></textarea>
                                            </div>
                                        </div>
                                    </div>
                            </li>
