          ...
          <ul style="list-style-type: none;" class="education_form">
            ...
            <div class="col-md-3"> 
              ...
              <div class="form-group">
                    ...
                    <input class="form-control demoDate" id="fromdate" value="{{$data->fromdate}}" name="fromdate" type="text" aria-describedby="emailHelp" placeholder="From" required="">
                </div>
             </div>
              <div class="col-md-3"> 
              <div class="form-group">
                    <label for="exampleInputEmail1">To</label>
                    <input class="form-control demoDate" id="todate" name="todate" value="{{$data->todate}}" type="text" aria-describedby="emailHelp" placeholder="To" required="">
                </div>
             </div>
