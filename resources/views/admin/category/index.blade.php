    ...
    <body class="app sidebar-mini rtl">
        ...
        <main class="app-content">
            <div class="app-title">
                ...
                <a href="{{url('/upload/category/create')}}" class="fa fa-plus btn btn-primary" style="background: #009688; border:none"> Add Category</a>  
            </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr style="max-height: 100px;">
                                                    ...
                                                    <td style="text-align: left;">
                                                        <a href="{{url('/upload/category/edit')}}/{{$cat->id}}" class="btn btn-primary btn-sm fa fa-edit"></a>
                                                        <a onclick="return confirm('Are you sure you want to delete this item?')" href="{{url('/upload/category/delete')}}/{{$cat->id}}" class="btn btn-danger btn-sm fa fa-trash"></a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
