  ...
  <main class="app-content">
      ...
      <div class="row  tile">
        <div class="col-md-12">
          ...
          <form action="{{url('/upload/category/update')}}/{{$id}}" method="post" enctype="multipart/form-data"  autocomplete="off">
          ...
          <ul style="list-style-type: none;" class="education_form">
            ...
            <div class="col-md-10"> 
              <div class="form-group">
                   ...
                   <input type="text" name="name" id="name" placeholder="Category Name" value="{{$cat->name}}" class="form-control" required="">
