...
<head>
 ...
 <link href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css" rel="stylesheet">
  ...
  <main class="app-content">
      ...
      <div class="row  tile">
        <div class="col-md-12">
          <form action="{{url('admin/news-upload/update')}}/{{$id}}" method="post" enctype="multipart/form-data"  autocomplete="off">
              ...
              <div class="form-group">
                    <label for="exampleInputEmail1">Category</label>
                     <select name="category" id="category" class="form-control" required="">
                       <option value="{{$newUpload->category}}">{{$newUpload->cat_name}}</option>
           ...
           <div class="row">
            <div class="col-md-7 col-md-offset-2"> 
              <div class="form-group">
                   ...
                   <input type="text" name="subject" id="subject"  value="{{$newUpload->subject}}" placeholder="Subject" class="form-control" required="">
             ...
             <div class="row">
              ...
              <div class="form-group">
                    ...
                    <input class="form-control" id="file" name="uploadimage"  type="file" aria-describedby="emailHelp" placeholder="Upload Image" value="{{$newUpload->uploadfile}}" required="">
                </div>
             </div>
             </div>
               <div class="row">
